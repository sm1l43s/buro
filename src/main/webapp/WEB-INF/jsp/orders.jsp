...
<div class="main">
    ...
    <p>На этой странице вы можете просмотреть список поданных технических заданий на проектирование домов. Для каждого технического задания вы можете узнать его статус, стоимость, бригаду конструкторов.</p>
